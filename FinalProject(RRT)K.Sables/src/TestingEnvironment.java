...
public class TestingEnvironment extends JPanel {
    @Override
    public void paintComponent(Graphics polygon) {
        ...
        // goal area
        VerticesNodes goalNode = new VerticesNodes((int)(Math.random() * ((1400 - 100) + 1) + 100), (int)(Math.random() * ((600 - 100) + 1) + 100),
                                                  0, 0);
        ...
        // start area
        VerticesNodes startNode = new VerticesNodes((int)(Math.random() * ((1400 - 100) + 1) + 100), (int)(Math.random() * ((600 - 100) + 1) + 100),
                                                    0, 0);
        shapes.setColor(Color.red);
        shapes.fillOval(startNode.getxValue(), startNode.getyValue(), 20, 20);

        int startX[] = {startNode.getxValue() - 50, startNode.getxValue() - 50, startNode.getxValue() + 50, startNode.getxValue() + 50};
        int startY[] = {startNode.getyValue() - 50, startNode.getyValue() + 50, startNode.getyValue() + 50, startNode.getyValue() - 50};
