...
public class NoObstacles3 extends JPanel {
    @Override
    public void paintComponent(Graphics polygon) {
        ...
        int goalX[] = {925, 925, 975, 975};
        int goalY[] = {292, 342, 342, 292};
        Polygon goalArea = new Polygon(goalX, goalY, 4);
        shapes.fillPolygon(goalArea);

        // start point with node
        VerticesNodes startNode = new VerticesNodes(600, 325, 0, 0);
        shapes.setColor(Color.red);
        shapes.fillOval(625, 350, 20, 20);

        int startX[] = {575, 575, 675, 675};
